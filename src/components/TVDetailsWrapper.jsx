...
const TVDetailsWrapper = ({ tvShow }) => {
  ...
  return (
    ...
    >
      <BackButton />
      <div className="flex flex-col justify-center items-center md:flex-row rounded-3xl sm:scale-100 scale-[90%] p-2 sm:p-5 m-3 sm:m-10 tv-details-content-container">

...
const MoviesWrapper = ({ movies, isLoading, componentTitle }) => {
  ...
  return (
    ...
    {movies.map(movie => (
      <div key={movie.id} className="p-1 m-2 rounded-md transition duration-300 ease-in-out hover:transform hover:-translate-y-1" style={{ minWidth: '200px', maxWidth: 'calc(15% - 1rem)' }}>

        ...
        <div className="flex flex-col bg-[#111111] text-gray-200 h-screen">
            <div className="flex justify-start items-center">
                ...
                <select
                    ...
                    className="w-1/4 px-4 py-2 border-b border-gray-200 shadow bg-[#111111] text-gray-200 cursor-pointer 
                    rounded-md
                ...
                <div className="w-3/4 text-center py-3">
                    {selectedEpisode ? (
                        <h2 className="text-xl font-semibold">{selectedEpisode.name}</h2>
                    ) : (
                        <h2 className="text-xl font-semibold">Select an episode</h2>
                    )}
                </div>
            </div>

  ...
  return (
    ...
    <h1 className=" text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 hover:text-gray-600 transition duration-300 ease-in-out m-4 p-4 ml-24">
      ...
      <div className="flex flex-wrap justify-center p-1">
        {tvShows.map(show => (
          <div key={show.id} className="p-1 m-2 rounded-md transition duration-300 ease-in-out hover:transform hover:-translate-y-1" style={{ minWidth: '200px', maxWidth: 'calc(15% - 1rem)' }}>
